...
platform_browser = {
'Windows': r'"C:\Program Files (x86)\Google\Chrome\Application\chrome.exe" --kiosk https://www.samehadaku.tv/',
'Linux' : ['/usr/bin/chromium-browser', '--kiosk', 'https://www.samehadaku.tv/']
}
